...
**MEG/EEG-pipeline** provides documentation for the Magnetoencephalography (MEG) system in the MEG laboratory and EEG setup within Brain Imaging Core Technology Platform.
