...
exppath = '/home/scw9/wray_workspace/BiDialect' # ENTER PATH TO EXPERIMENT FODLER HERE (folder containing meg and mri folders)
megpath = exppath + '/meg'
mripath = exppath + '/mri'
#os.chdir(exppath)
expname = 'BiDi' # ENTER EXPERIMENT CODENAME HERE (e.g., SAVANTARA or whatever convention we follow)
# pphelpers has all the functions that I use for preprocessing
from pphelpers_bidi import *

# Get a list of all the subjects
#subjlist = ['Y0398b','Y0399b']
subjlist = ['Y0405','Y0406','Y409']

tmin = -0.1  # INSERT TIME TO INCLUDE BEFORE TRIGGER (baseline) in SECONDS
tmax = 0.8  # INSERT EXTENT OF EPOCH, in SECONDS
