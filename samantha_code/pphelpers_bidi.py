...
def raw2epo(raw, tmin = -0.1, tmax = 0.8, baseline = (-0.1, 0.0)):
    '''
    ...
    #events = events[:121] #For SavantAra
    ...
    #event_id = dict(MSA_MSA=20,MSA_EGY=25,MSA_ENG=30,EGY_EGY=35,EGY_MSA=40,EGY_ENG=45) #EGY_ENG 1740 #EGY_EGY 1820 #EGY_MSA 1860
    event_id = dict(MSA_MSA=20,MSA_EGY=25,MSA_ENG=30,EGY_EGY=35,EGY_MSA=40,EGY_ENG=45)
