...
subjects = ['Y0119','Y0368','Y0369','Y0393','Y0395','Y0396']
...
#        rej_id = np.where(rejfile.accept==True)[0]
        ...
        fwd_fname = 'new_baseline/' + exp + 'meg/%s/%s-fwd.fif' %(subj,subj)
        cov_fname = 'new_baseline/' + exp + 'meg/%s/%s-cov.fif' %(subj,subj)
